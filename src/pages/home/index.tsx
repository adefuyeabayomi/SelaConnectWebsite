            ...
            <section className="services container py-2">
                ...
                <div className="row">
                    <div className="col-md-4">
                        <motion.div className="card service-card" whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.5 }}>
                    ...
                    <div className="col-md-4">
                        <motion.div className="card service-card" whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.5, delay: 0.2 }}>
                    ...
                    <div className="col-md-4">
                        <motion.div className="card service-card" whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.5, delay: 0.4 }}>
            ...
            <section className="how-it-works container py-2">
                ...
                <div className="row">
                    <div className="col-md-3">
                        <motion.div className="card how-it-works-card" whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.5 }}>
                            <FontAwesomeIcon icon={faMobileAlt} size="3x" color="#FF9B09" />
                            <h3>Step 1</h3>
                    ...
                    <div className="col-md-3">
                        <motion.div className="card how-it-works-card" whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.5, delay: 0.2 }}>
                            <FontAwesomeIcon icon={faBox} size="3x" color="#FF9B09" />
                            <h3>Step 2</h3>
                    ...
                    <div className="col-md-3">
                        <motion.div className="card how-it-works-card" whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.5, delay: 0.4 }}>
                            <FontAwesomeIcon icon={faTruck} size="3x" color="#FF9B09" />
                            <h3>Step 3</h3>
                    ...
                    <div className="col-md-3">
                        <motion.div className="card how-it-works-card" whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 50 }} transition={{ duration: 0.5, delay: 0.6 }}>
